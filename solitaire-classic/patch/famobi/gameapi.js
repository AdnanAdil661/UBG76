...
fg_api.prototype.getMoreGamesButtonImage = function(forceAbsolute) {
	...
	return "./patch/famobi/More_Games600x253_transparent.png?"+ mgb;
};
...
if (typeof window !== "undefined" && !window.famobi_tracking) {
    !function(a, b) {
        ...
        var tracking = {
            endpointUrl: './patch/famobi/tracking.json?https://data.html5games.com/',
            game: '',
...
fg_api.prototype.geoModule = function() {
	...
	function module() {
		...
		this.promise = null;
		this.geolocationUrl =
			"./patch/famobi/ip.json?https://pro.ip-api.com/json/?key=0meDkSsHhF3MQK0&fields=2";
		this.geodata = {
			countryCode: ""
		};
...
fg_api.prototype.init = function () {
	...
	function loadStylesheet() {
		return new Promise(function (resolve) {
			...
			newStylesheet.setAttribute(
				"href",
				"./patch/famobi/play.css?"+ self.config.assetsPath + "/css/play.css"
			);
	...
	function loadMoreGamesButton() {
		return new Promise(function (resolve) {
			...
			moreGamesImg.src = "./patch/famobi/More_Games600x253_transparent?"+ moreGamesBtn;
		});
	}
