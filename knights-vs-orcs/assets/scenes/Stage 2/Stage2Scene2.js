...
class Stage2Scene2 extends Phaser.Scene {
	...
	editorCreate() {
		...
		// elves_castle0
		const elves_castle0 = new CastlePrefab(this, -33, 488);
	...
	create() {
		// SET CURRENT STAGE
		localStorage.setItem("_CURRENT_STAGE", "Stage2Scene2");
	...
	spawnWINwindow(){
		...
		this.scene.run("PopUpScene", { sceneName: this.scene.key, scene: this.scene, tutorialMode: false, type: "WIN", nextScene: "Stage2Scene3" });
		this.scene.pause();
	}
