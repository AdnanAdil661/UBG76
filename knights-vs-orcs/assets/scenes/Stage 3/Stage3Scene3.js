...
class Stage3Scene3 extends Phaser.Scene {
	...
	editorCreate() {
		...
		// hightlight
		const hightlight = this.add.rectangle(1172, 896, 130, 108);
		...
		// bg4_1
		const bg4_1 = this.add.image(1987.0923004642796, 1133.296924619031, "bg4");
		bg4_1.setOrigin(0, 0);

		// elves_castle0_1
		const elves_castle0_1 = new CastlePrefab(this, 1954.0923004642796, 1646.296924619031);
		this.add.existing(elves_castle0_1);

		// orc_castle0_1
		const orc_castle0_1 = new EnemyCastlePrefab(this, 3891.0923004642796, 1646.296924619031);
		this.add.existing(orc_castle0_1);

		// hp_elven_castle_1
		const hp_elven_castle_1 = this.add.sprite(2187.0923004642796, 1354.296924619031, "hp", 10);

		// hp_orc_castle_1
		const hp_orc_castle_1 = this.add.sprite(3725.0923004642796, 1354.296924619031, "hp", 10);

		// crown_ui_1
		this.add.image(2580.0923004642796, 1203.296924619031, "crown_ui");

		// coin_ui_1
		this.add.image(2187.0923004642796, 1203.296924619031, "coin_ui");

		// settings_icon_1
		const settings_icon_1 = this.add.image(3850.0923004642796, 1193.296924619031, "settings_icon");

		// spearman_card_1
		const spearman_card_1 = this.add.image(2446.0923004642796, 2128.296924619031, "spearman_card");

		// axeman_card_1
		const axeman_card_1 = this.add.image(2650.0923004642796, 2128.296924619031, "axeman_card");

		// coinText_1
		const coinText_1 = this.add.text(2328.0923004642796, 1169.296924619031, "", {});
		coinText_1.text = "0\n";
		coinText_1.setStyle({"align":"right","fontFamily":"EnchantedLand","fontSize":"55px"});

		// crownText_1
		const crownText_1 = this.add.text(2719.0923004642796, 1169.296924619031, "", {});
		crownText_1.text = "0\n";
		crownText_1.setStyle({"align":"right","fontFamily":"EnchantedLand","fontSize":"55px"});

		// hightlight_1
		const hightlight_1 = this.add.rectangle(3154.0923004642796, 2027.296924619031, 130, 108);
		hightlight_1.visible = false;
		hightlight_1.isFilled = true;
		hightlight_1.fillColor = 15027761;

		// preeminentman_card_1
		const preeminentman_card_1 = this.add.image(2870.0923004642796, 2128.296924619031, "preeminentman_card");

		// archer_card_1
		const archer_card_1 = this.add.image(3090.0923004642796, 2128.296924619031, "archer_card");

		// swordy_card_1
		const swordy_card_1 = this.add.image(3319.0923004642796, 2128.296924619031, "swordy_card");
		...
		// elves_castle0_1 (components)
		new PhysicsComponent(elves_castle0_1);

		// orc_castle0_1 (components)
		new PhysicsComponent(orc_castle0_1);

		// spearman_card_1 (components)
		new CardComponent(spearman_card_1);

		// axeman_card_1 (components)
		new CardComponent(axeman_card_1);

		// preeminentman_card_1 (components)
		new CardComponent(preeminentman_card_1);

		// archer_card_1 (components)
		new CardComponent(archer_card_1);

		// swordy_card_1 (components)
		new CardComponent(swordy_card_1);
		...
		this.elves_castle0_1 = elves_castle0_1;
		this.orc_castle0_1 = orc_castle0_1;
		this.hp_elven_castle_1 = hp_elven_castle_1;
		this.hp_orc_castle_1 = hp_orc_castle_1;
		this.settings_icon_1 = settings_icon_1;
		this.spearman_card_1 = spearman_card_1;
		this.axeman_card_1 = axeman_card_1;
		this.coinText_1 = coinText_1;
		this.crownText_1 = crownText_1;
		this.hightlight_1 = hightlight_1;
		this.preeminentman_card_1 = preeminentman_card_1;
		this.archer_card_1 = archer_card_1;
		this.swordy_card_1 = swordy_card_1;
	...
	create() {
		// SET CURRENT STAGE
		localStorage.setItem("_CURRENT_STAGE", "Stage3Scene3");
		...
		this.orc_castle0.maxHealth = 6000;
		this.orc_castle0.health = 6000;
	...
	spawnWINwindow(){
		this.battle_music.stop();
		this.battle_win.play();
		this.scene.run("PopUpScene", { sceneName: this.scene.key, scene: this.scene, tutorialMode: false, type: "WIN", nextScene: "Stage4Scene1" });
		this.scene.pause();
	}
