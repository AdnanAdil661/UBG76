...
class Stage4Scene3 extends Phaser.Scene {
	...
	editorCreate() {
		...
		// crown_ui
		this.add.image(604, 70, "crown_ui");

		// coin_ui
		this.add.image(200, 70, "coin_ui");

		// settings_icon
		const settings_icon = this.add.image(1870, 60, "settings_icon");

		// spearman_card
		const spearman_card = this.add.image(466, 995, "spearman_card");
		...
		// hightlight
		const hightlight = this.add.rectangle(1199, 890, 130, 108);
		hightlight.visible = false;
		hightlight.isFilled = true;
		hightlight.fillColor = 15027761;

		// preeminentman_card
		const preeminentman_card = this.add.image(890, 995, "preeminentman_card");
		...
		// explosion_1
		const explosion_1 = this.add.sprite(1597, 490, "explosion_castle", 0);
		explosion_1.visible = false;

		// explosion_4
		const explosion_4 = this.add.sprite(1813, 781, "explosion_castle", 0);
		explosion_4.visible = false;

		// explosion_3
		const explosion_3 = this.add.sprite(1801, 373, "explosion_castle", 0);
		explosion_3.visible = false;

		// explosion_5
		const explosion_5 = this.add.sprite(1869, 607, "explosion_castle", 0);
		explosion_5.visible = false;

		// explosion_6
		const explosion_6 = this.add.sprite(1638, 680, "explosion_castle", 0);
		explosion_6.visible = false;

		// explosion_2
		const explosion_2 = this.add.sprite(1753, 552, "explosion_castle", 0);
		explosion_2.visible = false;

		// explosion_7
		const explosion_7 = this.add.sprite(1654, 376, "explosion_castle", 0);
		explosion_7.visible = false;
		...
		this.explosion_1 = explosion_1;
		this.explosion_4 = explosion_4;
		this.explosion_3 = explosion_3;
		this.explosion_5 = explosion_5;
		this.explosion_6 = explosion_6;
		this.explosion_2 = explosion_2;
		this.explosion_7 = explosion_7;
	...
	create() {
		// SET CURRENT STAGE
		localStorage.setItem("_CURRENT_STAGE", "Stage4Scene3");
		...
		this.scene.pause();
		this.exploding_boi = this.sound.add("castle_explosion_sfx");
		this.victory_crowd = this.sound.add("victory_crowd");
	}
	...
	spawnWINwindow(){
		localStorage.setItem("game", "complete");
		...
		this.timer5.remove();
		this.physics.pause();
		this.explosion_1.setVisible(true);
		this.explosion_1.anims.play("explosion");

		
		this.exploding_boi.play();
		this.exploding_boi.setVolume(0.5);
		
		this.victory_crowd.play();
		this.explosion_1.on('animationstart', () => {
			this.exploding_boi.play();
		}, this);

		this.explosion_2.on('animationstart', () => {
			this.exploding_boi.play();
		}, this);

		this.explosion_3.on('animationstart', () => {
			this.exploding_boi.play();
		}, this);

		this.explosion_4.on('animationstart', () => {
			this.exploding_boi.play();
		}, this);

		this.explosion_5.on('animationstart', () => {
			this.exploding_boi.play();
		}, this);

		this.explosion_6.on('animationstart', () => {
			this.exploding_boi.play();
		}, this);

		this.explosion_7.on('animationstart', () => {
			this.exploding_boi.play();
		}, this);

		this.explosion_1.on('animationcomplete', () => {
			this.explosion_2.setVisible(true);
			this.explosion_2.anims.play("explosion");
			this.explosion_1.destroy();
		}, this);

		this.explosion_2.on('animationcomplete', () => {
			this.explosion_3.setVisible(true);
			this.explosion_3.anims.play("explosion");
			this.explosion_2.destroy();
		}, this);

		this.explosion_3.on('animationcomplete', () => {
			this.explosion_4.setVisible(true);
			this.explosion_4.anims.play("explosion");
			this.explosion_3.destroy();
		}, this);

		this.explosion_4.on('animationcomplete', () => {
			this.explosion_5.setVisible(true);
			this.explosion_5.anims.play("explosion");
			this.explosion_4.destroy();
		}, this);

		this.explosion_5.on('animationcomplete', () => {
			this.explosion_6.setVisible(true);
			this.explosion_6.anims.play("explosion");
			this.explosion_5.destroy();
		}, this);

		this.explosion_6.on('animationcomplete', () => {
			this.explosion_7.setVisible(true);
			this.explosion_7.anims.play("explosion");
			this.explosion_6.destroy();
		}, this);

		this.explosion_7.on('animationcomplete', () => {
			this.explosion_7.destroy();
			this.scene.run("PopUpScene", { sceneName: this.scene.key, scene: this.scene, tutorialMode: false, type: "final_message"});
			this.scene.pause();				
		}, this);
	}
	...
	update(){
		...
		}else if(this.orc_castle0.health <= 0 && this.winTrigger == false){
			this.spawnWINwindow();
