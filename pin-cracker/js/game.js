...
var timerSpeedDefault = 1000; //default timer value, default is 1 sec
var timerSpeedIncrease = 150; //timer increase value each round
var timerBarDecreaseValue = 1; //timer bar decrease value

var inputAlertDelaySpeed = 200; //number colour indicator display speed
...
function goPage(page){
	...
	switch(page){
		...
		case 'result':
			...
			textFinalScoreDisplay.text = gameValue.score;
			saveGame(gameValue.score);
