function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: './sounds/',filename:'prepare_runner',loop:false,volume:1, ingamename: 'prepare_runner'});
        aSoundsInfo.push({path: './sounds/',filename:'crowd_arrival',loop:false,volume:1, ingamename: 'crowd_arrival'});
