function CInterface(iScore){
    ...
    this._init = function(iScore){                
        ...
        _oScoreNum = new createjs.Text(iScore,"50px "+FONT, "#600101");
        ...
        _oScoreNum1 = new createjs.Text(iScore,"50px "+FONT, "#ffffff");
        ...
        _oTimeNum = new createjs.Text("00:00","50px "+FONT, "#600101");
        ...
        _oTimeNum1 = new createjs.Text("00:00","50px "+FONT, "#ffffff");
        ...
        _oTimerLevelNum = new createjs.Text("00:00","50px "+FONT, "#600101");
        ...
        _oTimerLevelNum1 = new createjs.Text("00:00","50px "+FONT, "#ffffff");
    ...
    this.seeGoal = function(szSprite, num, numEated, off_x, off_y){
        ...
        _aText.push(new createjs.Text(numEated+"/"+num,"40px "+FONT, "#600101"));
        ...
        _aText1.push(new createjs.Text(numEated+"/"+num,"40px "+FONT, "#ffffff"));
