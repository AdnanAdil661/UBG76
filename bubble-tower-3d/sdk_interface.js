...
const SDK_INTERFACE_SETTINGS = {
  ...
  // files to load
  externalFiles: ["sdk_interface_custom.js", "gameanalytics.js"],
...
const SDK_INTERFACE_SHOW_AD = function () {
  return new Promise(function (resolve, reject) {
    ...
    window.gdsdk
      .showAd()
      .then(() => {
        SDK_INTERFACE.settings.debugLevel &&
...
const SDK_INTERFACE_INIT = function () {
  return new Promise(function (resolve, reject) {
            ...
            case "rewarded":
              return new Promise(function (resolve, reject) {
                if (confirm("Rewarded ad ended. Should a reward be granted?")) {
                  typeof gdsdk_SDK_REWARDED_WATCH_COMPLETE === "function" &&
                    gdsdk_SDK_REWARDED_WATCH_COMPLETE();
                } else {
                }
                return resolve();
    ...
    window["GD_OPTIONS"] = {
      gameId: "be1021551994487d8cd6934a9164000c",
      ...
      onEvent: function (event) {
        switch (event.name) {
          case "SDK_READY":
            SDK_INTERFACE.settings.debugLevel &&
              console.log("[GD_OPTIONS.onEvent] SDK_READY");
            typeof gdsdk_SDK_READY === "function" && gdsdk_SDK_READY();
            break;
          case "SDK_GAME_START":
            SDK_INTERFACE.settings.debugLevel &&
              console.log("[GD_OPTIONS.onEvent] SDK_GAME_START");
            // advertisement done, resume game logic and unmute audio
            typeof gdsdk_SDK_GAME_START === "function" &&
              gdsdk_SDK_GAME_START();
            break;
          case "SDK_GAME_PAUSE":
            SDK_INTERFACE.settings.debugLevel &&
              console.log("[GD_OPTIONS.onEvent] SDK_GAME_PAUSE");
            // pause game logic / mute audio
            typeof gdsdk_SDK_GAME_PAUSE === "function" &&
              gdsdk_SDK_GAME_PAUSE();
            break;
          case "SDK_GDPR_TRACKING":
            SDK_INTERFACE.settings.debugLevel &&
              console.log("[GD_OPTIONS.onEvent] SDK_GDPR_TRACKING");
            // this event is triggered when your user doesn't want to be tracked
            typeof gdsdk_SDK_GDPR_TRACKING === "function" &&
              gdsdk_SDK_GDPR_TRACKING();
            break;
          case "SDK_GDPR_TARGETING":
            SDK_INTERFACE.settings.debugLevel &&
              console.log("[GD_OPTIONS.onEvent] SDK_GDPR_TARGETING");
            // this event is triggered when your user doesn't want personalised targeting of ads and such
            typeof gdsdk_SDK_GDPR_TARGETING === "function" &&
              gdsdk_SDK_GDPR_TARGETING();
            break;
          case "AD_ERROR":
            SDK_INTERFACE.settings.debugLevel &&
              console.log("[GD_OPTIONS.onEvent] AD_ERROR");
            typeof gdsdk_AD_ERROR === "function" && gdsdk_AD_ERROR();
            break;
          case "AD_IS_ALREADY_RUNNING":
            SDK_INTERFACE.settings.debugLevel &&
              console.log("[GD_OPTIONS.onEvent] AD_IS_ALREADY_RUNNING");
            typeof gdsdk_AD_IS_ALREADY_RUNNING === "function" &&
              gdsdk_AD_IS_ALREADY_RUNNING();
            break;
          case "SDK_REWARDED_WATCH_COMPLETE":
            SDK_INTERFACE.settings.debugLevel &&
              console.log("[GD_OPTIONS.onEvent] SDK_REWARDED_WATCH_COMPLETE");
            typeof gdsdk_SDK_REWARDED_WATCH_COMPLETE === "function" &&
              gdsdk_SDK_REWARDED_WATCH_COMPLETE();
            break;
          default:
    ...
    (function (d, s, id) {
      ...
      js.id = id;
      js.src = './patch/gamedistribution/main.js?html5.api.gamedistribution.com/main.min.js';
